...
var thumbImg = document.querySelectorAll('.thumb_img');
var wrap = document.querySelector('.wrap');

// 보여주는 박스
function showBigImg() {
  var picAttr = this.getAttribute("src");

  // div 만들기 - 밑에서 클래스추가되면 스타일 시트에서 클래스 정의해주면됨.
  var windowBox = document.createElement("div");
  var windowInnerBox = document.createElement("div");
  ...
  var textDescryption = document.createElement("div");
  ...
  windowBox.addEventListener('click', function () {
